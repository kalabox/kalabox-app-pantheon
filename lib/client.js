...
Client.prototype.auth = function(email, password) {
  ...
  // Set our stuff
  var data = {
    machine_token: 'zdkjhj58Zu4QGaG1h5totplQT5DncCglSFtpeTEs3MHIN',
    client: 'terminus'
  };
  ...
  var options = {
    headers: {
      'Content-Type': 'application/json',
      'User-Agent': 'Terminus/0.11.2 Kalabox'
    }
  };

  // Send REST request.
  return this.__request('postJson', ['authorize', 'machine-token'], data, options)

  //zdkjhj58Zu4QGaG1h5totplQT5DncCglSFtpeTEs3MHIN
